...
//
// 有部分库开始支持 tree-shaking，比如 redux 的 package.json 有 2 个配置
// "main": "lib/index.js",
// "jsnext:main": "es/index.js",
//
// 需要配置 webpack 的 resolve.mainFields 字段 ['jsnext:main', 'main']，这会让 webpack 优先使用 jsnext:main 字段，没有时再使用 main 字段。
